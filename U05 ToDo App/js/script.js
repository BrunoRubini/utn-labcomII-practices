...
function addTask() {
  ...
  if (newTask.value.trim() != "") {
    ...
    addElementToLocal("Task", arrayTasks); //Esta linea es para agregar la tarea en el storage, lo que hacemos es crear un array y guardamos el array en el storage
    newTask.value = "";
  }
}
